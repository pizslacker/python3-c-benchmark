...
It allocates a 100-million element array, runs a single-threaded benchmark comparing a standard C loop to inline idiomatic `Python3` code, and shows a spinner animation.
